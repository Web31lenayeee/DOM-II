...
// 1. (mouseover) Nav bar highlight color effect
...
// 2. (scroll) Map photo scroll zoom effect
function zoom(event) {
...
// find ways to update the DOM in creative ways. 
// For example you could change colors, animate objects, 
// remove objects, etc.
...
const clickImg = document.querySelector('.img-content')
...
const resizer = document.querySelector('body');
